package com.example.roomcronoapp.component
...
//recuerda que se utiliza Unit para enviar funciones a elementos clickables
@Composable
fun CronCard(titulo: String, crono: String, onClick: () -> Unit) {
    Box(
        ...
        Column(
            ...
            Row {
                Icon(
                    //agregamos el vectorAsset que creamos en pasos anteriores
            ...
            //una linea para diferenciar entre cada elemento
            Divider(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(1.dp),
